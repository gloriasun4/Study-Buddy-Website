...
class ScheduleViewTest(TestCase):
    ...
    def test_view_url_exists_at_desired_location(self):
        ...
        """
        response = self.client.get(('/studybuddy/', self.test_room, '/schedule'),
                                    follow=True)
    ...
    def test_view_uses_correct_template(self):
        ...
        self.assertTemplateUsed(response, 'schedule_session/schedule.html')
...
class UpcomingSessionsViewTest(TestCase):
    ...
    def test_view_uses_correct_template(self):
        ...
        response = self.client.get(reverse('studybuddy:upcomingSessions'))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'schedule_session/upcomingSessions.html')
